...
util_rbtree_node_t *__conhash_get_rbnode(struct conhash_s *conhash, struct node_s *node, long hash);
void __conhash_del_rbnode(struct conhash_s *conhash, util_rbtree_node_t *rbnode);
