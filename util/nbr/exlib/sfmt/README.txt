 ...
 ==================================================================
 hi! Im takehiro iyatomi(iyatomi@gmail.com). I modify some changes to
 SFMT.c so that it can work under multithread environment. 
 so if you use this version of SFMT** and encounter some problem,
 please notice me first :D
 and html/*** section is also delete by me, so cannot available.
